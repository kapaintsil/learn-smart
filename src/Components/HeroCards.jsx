      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {heroCardFeatures.map((feature, index) => (
            <div
              key={index}
              className='card p-8 text-center hover:shadow-lg transition-shadow duration-300 group'
            >
              <div className='w-16 h-16 mx-auto mb-6 bg-primary-100 dark:bg-primary-900 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300'>
                <img
                  src={feature.logo}
